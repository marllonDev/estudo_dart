...
//na linha 11 o primeiro map está buscando a chave 'nota' de cada aluno e não está fazendo nenhuma transformação de tipo. No segundo map ele está transformando a nota buscada para double(pq precisa se double para ser somado todos os números).No 'reduce' está a lógica, o que deve ser feito com cada nota, que o caso é somar uma com outra até chegar ao valor total. E o 'where' está fazendo o filtro, colocando somente os alunos que tem a nota maior que 8.
